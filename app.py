...
# ส่วนหัวของแอป
st.markdown('<p class="title">💰 แอปคำนวณค่าใช้จ่ายประกันสุขภาพ</p>', unsafe_allow_html=True)
st.markdown('<p class="subtitle">🔍 ทำนายค่าใช้จ่ายทางการแพทย์จากข้อมูลส่วนบุคคลของคุณ</p>', unsafe_allow_html=True)
